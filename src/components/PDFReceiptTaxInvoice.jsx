...
const PDFReceiptTaxInvoice = (props) => {
						...
						>
							...
							<View style={styles.table}>
								...
								<View style={styles.tableRow}>
									<View style={styles.tableCol}>
										<Text style={styles.tableCellHeader}>
											{props.receiptTaxInvoice.PaymentType}
										</Text>
									</View>
									<View style={styles.tableCol}>
										<Text style={styles.tableCellHeader}>
											{props.receiptTaxInvoice.date}
										</Text>
									</View>
									<View style={styles.tableCol}>
										<Text style={styles.tableCellHeader}>
											{props.receiptTaxInvoice.price}
										</Text>
									</View>
								</View>
							</View>
...
export default PDFReceiptTaxInvoice;
